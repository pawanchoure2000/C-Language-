...
class complex
{
	...
	public :
		...
		//copy constructar is not  defined  
		~complex()
		{
			cout<<"complex  destructar "<<endl;
			print();
		...
		int print()
		{
			cout<<"  re="<<re_<<"  im="<<im_<<"  norm="<<norm()<<endl;  return 420;
		}


};

int display(complex c_par)
{
	cout<<"display "<<c_par.print();		//c_par.pprint()  gives the return value of print()           //it runs perfectly on online compliler 
}
