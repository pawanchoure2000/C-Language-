...
//function with samedeclartion ,but with different returntype result in redeclartion of function //error //function cannot be overloaded withthe returntype //IMP 
//overloading allows static polymorphism
		 
//candidate function: 	same function name 
// viable function : different # on parameter :::::::::  number of parameter are same , different types of parameter
// best viable function : number of parameter are different , but type overlaap 
//  functon selection is known as overload resolution //WHAT IS OVERLOAD RESOLUTION????? 
...
//cannot convert double to int because it loses information.......
//example of promotion
//char to int ; float to double ;
//enum to int/short /unsigned int ....
//bool to int 
//example of standard conversion
//int , float , float := may be dangerous
//pointer  , bool 

//2200
//lvalue : address of variable  left value 
//rvalue : value of variable    right  value

//ambugity call to overloaded fuunction 

//operetar overloading
mytype a,b;		//enum //struct 
mytype opertar+(mytype ,mytype );		//opertar function 
a+b;			//calls opertar function
//c++ allows user to define it.s own opertar function 
/
